    ...
    <div className='wrapper-df'>
      <div className="pain-form-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='video-time-notice'>
    <p>För bokning av videosamtal skickar vi dig en länk till ClinicBuddy där du själv kan välja en tid som passar, tillsammans med en bokningsbekräftelse.
<br />
Vill du hellre boka tid via telefon? Inga problem – vi ringer upp dig samma dag för att komma överens om en tid som passar dig.</p>
 </div>
...
export default DynamicFormVideo;
